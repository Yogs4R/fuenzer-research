        ...
        <div className="bg-paper-white dark:bg-ink-black rounded-2xl shadow-xl border border-cloud-canvas dark:border-stone-gray p-8 relative">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-gray dark:text-silver-mist font-sans">
              Join Fuenzer Research and sync your workspace across devices
            </p>
          </div>
          ...
          {displayError && (
            <div className="mb-4 p-3 rounded-xl bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800/30 text-red-600 dark:text-red-400 text-xs font-sans flex items-center justify-between">
              ...
              <button onClick={() => { clearError(); setLocalError(''); }} className="ml-2 underline text-[10px] cursor-pointer shrink-0 font-semibold">Tutup</button>
            </div>
          )}
