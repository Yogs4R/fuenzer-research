                  ...
                  <div className="relative" ref={profileRef}>
                    ...
                    >
                      {user.photoURL ? (
                        <img
                          ...
                          className={`w-8 h-8 rounded-full border-2 transition-colors ${isProfileOpen ? 'border-fuenzer-teal' : 'border-cloud-canvas dark:border-stone-gray hover:border-fuenzer-teal'}`}
                          referrerPolicy="no-referrer"
                        />
                      ) : (
                        <div className={`w-8 h-8 rounded-full bg-fuenzer-teal/10 border-2 flex items-center justify-center transition-colors ${isProfileOpen ? 'border-fuenzer-teal' : 'border-cloud-canvas dark:border-stone-gray hover:border-fuenzer-teal'}`}>
                    ...
                    {isProfileOpen && (
                      <div className="absolute top-12 right-0 w-64 bg-paper-white dark:bg-ink-black border border-cloud-canvas dark:border-stone-gray shadow-xl rounded-xl overflow-hidden animate-in fade-in z-50">
                        ...
                        <div className="py-1">
                          <button
                            onClick={() => { setIsProfileOpen(false); navigate('/library'); }}
                          ...
                          <button
                            onClick={() => { setIsProfileOpen(false); navigate('/citations'); }}
                            className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-ink-black dark:text-cloud-canvas hover:bg-cloud-canvas/60 dark:hover:bg-stone-gray/30 transition-colors text-left"
                          >
